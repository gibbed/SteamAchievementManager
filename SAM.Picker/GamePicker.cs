...
namespace SAM.Picker
{
    internal partial class GamePicker : Form
    {
        ...
        private readonly AppDataChanged _AppDataChangedCallback;
        ...
        public GamePicker(Client client)
        {
            ...
            _AppDataChangedCallback = client.CreateAndRegisterCallback<AppDataChanged>();
        ...
        {
            if (param.Result && _Games.ContainsKey(param.Id))
            {
        ...
        {
            var logo = _SteamClient.SteamApps001.GetAppData(info.Id, "logo");
            ...
            var imageIndex = _LogoImageList.Images.IndexOfKey(logo);
            if (imageIndex >= 0)
            {
